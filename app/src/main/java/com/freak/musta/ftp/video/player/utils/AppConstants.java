...
public class AppConstants {
    ...
    public static final String IS_SANS_SERIF_SELECTED = "selected_font";
    public static final String IS_DARK_THEME = "selected_dark";
    public static final String VISIT_COUNTS = "section_visits";
